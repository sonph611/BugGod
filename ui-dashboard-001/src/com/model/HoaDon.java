...
public class HoaDon {
    ...
    public HoaDon(String maHD, Date thoiGianTao, Date thoiGianThanhToan, String nguoiTao, double tongTien, double chiPhiKhac, String hinhThucThanhToan, String ghiChu, String trangThai, String tenNguoiTao) {
        this.maHD = maHD;

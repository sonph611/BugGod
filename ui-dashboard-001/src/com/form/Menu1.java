...
//                    JOptionPane.showMessageDialog(null, "" + item.getMaSP() + " " + item.getTenSP());
    ...
    HoaDon getForm() {
        ...
        modelGF.setNguoiTao("NV001");
        String tongTien = lblTongTien.getText().replaceAll("VNĐ", "");
        modelGF.setTongTien(Double.parseDouble(tongTien));
        ...
        modelGF.setTenNguoiTao("Nguyễn Hữu Phúc");
        return modelGF;
    }
    ...
    public void addHDCT() {
        for (int i = 0; i < tblHoaDon.getRowCount(); i++) {
            ...
            hdct.setTongTien((double) tblHoaDon.getValueAt(i, 3));
